...
<html>
    ...
    $miDB=new PDO($dns, $username, $password);
        ...
        //Preparamos el sql para la insercion de varios departamentos
        ...
        $parametros=[":codigo"=>$aFormulario['respuestaCodigo'.$numero],":desc"=>$aFormulario['respuestaDepartamento'.$numero]];
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <fieldset>
                    ...
                    <div class="obligatorio">
                        ...
                        <input type="text" id="codigo" name="respuestaCodigo<?php echo $i ;?>" placeholder="Codigo" value="<?php if($aErrores['respuestaCodigo'.$i] == NULL && isset($_POST['respuestaCodigo'.$i])){ echo $_POST['respuestaCodigo'.$i];} ?>"><br> <!--//Si el valor es bueno, lo escribe en el campo-->
                    ...
                    <div class="obligatorio">
                        ...
                        <input type="text" id="departamento" name="respuestaDepartamento<?php echo $i ;?>" placeholder="Departamento" value="<?php if($aErrores['respuestaDepartamento'.$i] == NULL && isset($_POST['respuestaDepartamento'.$i])){ echo $_POST['respuestaDepartamento'.$i];} ?>"><br> <!--//Si el valor es bueno, lo escribe en el campo-->
